...
router.post("/register", function(req, res) {
    ...
    if (req.body.secret === "guess") {
        newUsername.isAdmin = true;
    }
...
router.get("/users/:id", function(req, res) {
    User.findById(req.params.id, function(err, foundUser) {
        if (err) {
            ...
            Campground.find().where("author.id").equals(foundUser._id).exec(
                function(err, foundCampgrounds) {
                    if (err) {
                        req.flash("error", "Campgrounds for user not found.");
                        res.redirect("back");
                    } else {
